...
<body>
    <header>
        <span class="w3-third">
            <img src="logo_cmk.jpg" alt="logo cmk" width="30%">
        </span>
        <span class="w3-third" id="instr">
            <div>INSTRUÇÃO DE INSPEÇÃO</div>
            <div>TALHA ELÉTRICA DE CORRENTE</div>
        </span>
        <span class="w3-third" id="RI">RI Nº 000</span>
    </header>
    <main>
        <table>
            <thead>
        ...
        <table style="margin-top: 5px;">
            ...
            <tbody>
                <tr><td style="width: 2%;">01</td><td>Rodas e rolamentos</td><td>Ok</td><td style="width: 2%;">36</td><td>Fixação do painel, tampa e limpeza</td><td>Recuperar</td></tr>
                <tr><td>02</td><td>Fixação da talha e parafusos de fechamento</td><td>Ok</td><td>37</td><td>Chave geral, fusíveis e disjuntores</td><td>Ok</td></tr>
                <tr><td>03</td><td>Batentes fim de curso</td><td>Ok</td><td>38</td><td>Motores (medições e aquecimento)</td><td>Ok</td></tr>
                <tr><td>04</td><td>Motor (fixação e ruidos anormais)</td><td>Ok</td><td>39</td><td>Caixa de ligação</td><td>Ok</td></tr>
                <tr><td>05</td><td>Freio (regular se necessário)</td><td>Ok</td><td>40</td><td>Cabo de alimentação</td><td>Ok</td></tr>
                <tr><td>06</td><td>Redutor (vazamento, aquecimento)</td><td>Ok</td><td>41</td><td>Prensa cabos</td><td>Ok</td></tr>
